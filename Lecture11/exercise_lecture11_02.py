...
os.mkdir("/localdisk/home/s2478435/Exercises/Lecture11")
os.chdir("/localdisk/home/s2478435/Exercises/Lecture11")
os.system("cp /localdisk/data/BPSM/Lecture11/plain_genomic_seq.txt . ")
print("\n".join(os.listdir()))
local_seq = open("plain_genomic_seq.txt").read().rstrip()
subprocess.call("esearch -db nucleotide -query \"AJ223353[accession]\" |
  efetch -format fasta | grep -v \">\" > AJ223353_noheader.fasta3",shell=True)
